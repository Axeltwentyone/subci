...
class ServiceSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $services = [
            ...
            ['deezer', 'DZ', 'Deezer Famille', '#A238FF', '#FFFFFF', 'music', 'Sans pub · hors ligne', 'Ton compte Deezer Premium perso dans un groupe famille. Sans pub, écoute hors ligne.', 1000, 4500, 6, 0, 30, false],
